...
class Orders
{
  public:
    struct Cols
    {
        ...
        static const std::string _user_info;
    ...
    /**  For column user_info  */
    ///Get the value of the column user_info, returns the default value if the column is null
    const std::string &getValueOfUserInfo() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getUserInfo() const noexcept;
    ///Set the value of the column user_info
    void setUserInfo(const std::string &pUserInfo) noexcept;
    void setUserInfo(std::string &&pUserInfo) noexcept;
  ...
  private:
    ...
    std::shared_ptr<std::string> userInfo_;
